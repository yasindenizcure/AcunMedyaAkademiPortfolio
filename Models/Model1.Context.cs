...
namespace AcunMedyaAkademiPortfolio.Models
{
    ...
    public partial class DbPortfolioEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetLastSkillTitle_Result> GetLastSkillTitle()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetLastSkillTitle_Result>("GetLastSkillTitle");
        }
        ...
        public virtual ObjectResult<string> GetLastSkillTitle1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("GetLastSkillTitle1");
        }
    }
}
